...
📊 **ERP Management System *(Private — Company Project)***
> Developed responsive ERP interfaces including authentication, employee management, attendance, payroll dashboards, reports, reusable UI components, and role-based views. **Stack:** React · JavaScript · HTML5 · CSS3 · Tailwind CSS · REST API

🤝 **AMPLIMENTOR – Mentorship Platform**
> Mentorship platform connecting students and mentors through a responsive interface featuring authentication, profile management, scheduling, and layout dashboards. **Stack:** HTML5 · CSS3 · JavaScript

🎬 **MovieZone – Movie Browsing App**
> Responsive movie browsing application with search capabilities, genre categories, and detailed movie profiles. **Stack:** React.js · JavaScript · Bootstrap
